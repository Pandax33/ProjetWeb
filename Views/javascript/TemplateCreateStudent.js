...
function validateForm() {
    ...
    if (!promotionSelect || promotionSelect.value.length === 0){alert('Veuillez sélectionner une promotion.');
    return false;
    }
    ...
    // Attachez la fonction validateForm au bouton de soumission du formulaire
