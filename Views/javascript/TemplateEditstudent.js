document.addEventListener('DOMContentLoaded', function () {
    ...
    etudiantSelect.addEventListener('change', function () {
      ...
      const promotionOption = Array.from(promotionSelect.options).find(option => option.textContent === promotions);
      if (promotionOption) {
      promotionSelect.value = promotionOption.value;
      }
      });
      
      // Activer Select2 pour le champ compétences
